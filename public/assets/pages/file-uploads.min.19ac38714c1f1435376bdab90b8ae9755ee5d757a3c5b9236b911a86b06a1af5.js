!(function (e, t) {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const b = document.querySelector("#_dm-dzTemplate"),
      e = b.parentNode.innerHTML;
    (b.id = ""), b.parentNode.removeChild(b);
    const c = document.querySelector("#dz-upload-btn"),
      d = document.querySelector("#dz-remove-btn"),
      a = new Dropzone(document.body, {
        url: "/target-url",
        thumbnailWidth: 50,
        thumbnailHeight: 50,
        parallelUploads: 5,
    ...
    a.on("addedfile", (a) => {
      c.removeAttribute("disabled"), d.removeAttribute("disabled");
    }),
      a.on("totaluploadprogress", (a) => {
        document.querySelector(
          "#_dm-dzProgress .progress-bar"
        ).style.width = `${a}%`;
      }),
      a.on("sending", (a) => {
        document.querySelector("#_dm-dzProgress").style.opacity = "1";
      }),
      a.on("queuecomplete", (a) => {
